...
它在 win 环境下开发的话, 总是会检测 VS, 但又没检测到.. 后来才意识到应该用 MingW 作为工具链 -> [在 Clion 上连接 WSL2 并使用 XMake 开发 C++](../WSL_Clion_xmake.md)
...
![Nuxt 的 SSR 和 /server 部分也好好玩。但是 Vercel......不能直接数据持久化，还得是数据库](/blog/diary/23-07-05.webp)
